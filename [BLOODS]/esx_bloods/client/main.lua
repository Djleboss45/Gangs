...
function OpenArmoryMenu(station)
  ...
  if Config.EnableArmoryManagement then
    ...
    for i=1, #Config.bloodsStations[station].AuthorizedWeapons, 1 do
      local weapon = Config.bloodsStations[station].AuthorizedWeapons[i]
...
function OpenVehicleSpawnerMenu(station, partNum)
  ...
  local vehicles = Config.bloodsStations[station].Vehicles
  ...
  if Config.EnableSocietyOwnedVehicles then
    ...
    for i=1, #Config.bloodsStations[station].AuthorizedVehicles, 1 do
      local vehicle = Config.bloodsStations[station].AuthorizedVehicles[i]
        ...
        if not DoesEntityExist(vehicle) then
          ...
          if Config.MaxInService == -1 then
            ...
            ESX.Game.SpawnVehicle(model, {
			  ...
			  SetVehicleNumberPlateText(vehicle," bloods  “ .. numberplate .. ”")
			  local color = GetIsVehiclePrimaryColourCustom(vehicle)
			  SetVehicleCustomPrimaryColour(vehicle, 250, 4, 4)
            end)
...
function OpenFineCategoryMenu(player, category)
  ...
  ESX.TriggerServerCallback('esx_bloodsjob:getFineList', function(fines)
...
AddEventHandler('esx_bloodsjob:hasEnteredEntityZone', function(entity)
  ...
  if (PlayerData.job ~= nil and PlayerData.job.name == 'bloods') or (PlayerData.job2 ~= nil and PlayerData.job2.name == 'bloods') or (PlayerData.job3 ~= nil and PlayerData.job3.name == 'bloods') and not IsPedInAnyVehicle(playerPed, false) then
...
Citizen.CreateThread(function()
  while true do
    ...
    if (PlayerData.job ~= nil and PlayerData.job.name == 'bloods') or (PlayerData.job2 ~= nil and PlayerData.job2.name == 'bloods') or (PlayerData.job3 ~= nil and PlayerData.job3.name == 'bloods') then
      ...
      for k,v in pairs(Config.bloodsStations) do
        ...
        if Config.EnablePlayerManagement and PlayerData.job ~= nil and PlayerData.job.name == 'bloods' and PlayerData.job.grade_name == 'boss' then
		...
		if Config.EnablePlayerManagement and PlayerData.job3 ~= nil and PlayerData.job3.name == 'bloods' and PlayerData.job3.grade_name == 'boss' then
...
Citizen.CreateThread(function()
  while true do
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlPressed(0,  Keys['E']) and PlayerData.job ~= nil and PlayerData.job.name == 'bloods' and (GetGameTimer() - GUI.Time) > 150 then
   ...
   if IsControlPressed(0,  Keys['F6']) and PlayerData.job ~= nil and PlayerData.job.name == 'bloods' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'bloods_actions') and (GetGameTimer() - GUI.Time) > 150 then
...
Citizen.CreateThread(function()
  while true do
   ...
   if IsControlPressed(0,  Keys['F7']) and PlayerData.job2 ~= nil and PlayerData.job2.name == 'bloods' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'bloods_actions') and (GetGameTimer() - GUI.Time) > 150 then
     OpenbloodsActionsMenu()
     GUI.Time = GetGameTimer()
    end
...
Citizen.CreateThread(function()
  while true do
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlPressed(0,  Keys['E']) and PlayerData.job3 ~= nil and PlayerData.job3.name == 'bloods' and (GetGameTimer() - GUI.Time) > 150 then
   ...
   if IsControlPressed(0,  Keys['F9']) and PlayerData.job3 ~= nil and PlayerData.job3.name == 'bloods' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'bloods_actions') and (GetGameTimer() - GUI.Time) > 150 then
     OpenbloodsActionsMenu()
     GUI.Time = GetGameTimer()
    end
